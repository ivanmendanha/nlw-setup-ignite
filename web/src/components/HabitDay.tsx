...
export function HabitDay({ defaultCompleted = 0, amount = 0, date }: HabitProps) {
    ...
    return (
        <Popover.Root>
            <Popover.Trigger 
                className={clsx('w-10 h-10 rounded-lg transition-colors focus:outine-none focus:ring-2 focus:ring-violet-700 focus: ring-offset-2 focus:ring-offset-background', {
